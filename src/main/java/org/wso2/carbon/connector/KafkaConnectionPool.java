...
public class KafkaConnectionPool {
    ...
    private static Vector<KafkaProducer> connectionPool = new Vector<>();
     ...
     * @return the connection.
     */
    public static synchronized KafkaProducer getConnectionFromPool() {
     ...
     */
    public static synchronized void returnConnectionToPool(KafkaProducer connection) {
        if (log.isDebugEnabled()) {
